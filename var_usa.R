...
# 3. Mostriamo le prime righe dei dati per un controllo rapido ####
head(data)

# 4. Cambiamo il formato della colonna "periodo" ####
data$periodo <- as.yearqtr(data$periodo, format = "%Y Q%q")

# 5. Visualizziamo le 3 serie storiche ####
...
# 6. Esprimiamo anche il tasso di inflazione in termini annuali ####
...
# 7. Riorganizziamo i dati come serie storiche ####
data_ts <- ts(data[,], start = c(1981, 1), frequency = 4)

# 8. Controlliamo se le serie sono stazionarie ####
...
# 15. Creiamo le funzioni di risposta ad impulso (IRF) sul tasso di interesse ####
...
# 17. Visualizziamo le funzioni di risposta ad impulso ####
layout(matrix(c(1,2,3,4), 2, 2, byrow = TRUE))
...
# 18. Effettuiamo delle previsioni circa l'andamento futuro delle variabili ####
