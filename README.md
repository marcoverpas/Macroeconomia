[*Italian only*] In quest'area sono disponibili i codici `R` per gli studenti dell'insegnamento di **Macroeconomia** per le lauree triennali di area economica attivo presso l'Università dell'Aquila. Le indicazioni necessarie per utilizzare il materiale qui caricato saranno fornite nel corso delle lezioni.
